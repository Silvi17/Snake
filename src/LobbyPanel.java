...
class LobbyPanel extends JPanel{
    ...
    public static final String CREATOR_MESSAGE = "Creado por González López Silvana Gabriela - 2023";
    ...
    public static final String[] MENU_ITEMS = {"Jugar", "Mejores Snake", "Salir"};
